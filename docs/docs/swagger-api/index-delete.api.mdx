...
sidebar_label: "Index::Delete"
hide_title: true
hide_table_of_contents: true
api: {"operationId":"index_delete","responses":{"200":{"description":"A successful response.","content":{"application/json":{"schema":{"type":"object","title":"apiDeleteIndexResponse"}}}},"default":{"description":"An unexpected error response.","content":{"application/json":{"schema":{"type":"object","properties":{"code":{"type":"integer","format":"int32"},"message":{"type":"string"},"details":{"type":"array","items":{"type":"object","properties":{"@type":{"type":"string"}},"additionalProperties":{},"title":"protobufAny"}}},"title":"rpcStatus"}}}}},"requestBody":{"content":{"application/json":{"schema":{"type":"object","properties":{"name":{"type":"string"}},"title":"apiDeleteIndexRequest"}}},"required":true},"tags":["Api"],"description":"Index::Delete","method":"post","path":"/index/delete","jsonRequestBodyExample":{"name":"string"},"info":{"title":"embedds","version":"1.0.0","contact":{"name":"anansi","url":"https://github.com/infrawhispers/anansi","email":"infrawhispers@proton.me"},"license":{"name":"Apache 2.0 License","url":"https://github.com/infrawhispers/anansi/blob/main/LICENSE"}},"postman":{"name":"Index::Delete","description":{"type":"text/plain"},"url":{"path":["index","delete"],"host":["{{baseUrl}}"],"query":[],"variable":[]},"header":[{"key":"Content-Type","value":"application/json"},{"key":"Accept","value":"application/json"}],"method":"POST","body":{"mode":"raw","raw":"\"\"","options":{"raw":{"language":"json"}}}}}
