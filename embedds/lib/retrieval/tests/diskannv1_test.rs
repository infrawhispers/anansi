...
// use retrieval::diskannv1;
// use retrieval::metric;
// use retrieval::flat_full::{FlatFullParams, FlatIndex as FlatFullIndex};
...
mod test {
    ...
    fn sift_1m_flat() {
        ...
        // let params = ann::ANNParams::FlatFull {
        //     params: retrieval::flat_lite::FlatLiteParams {
        //         dim: 128,
        //         segment_size_kb: 512,
        //     },
        ...
        // let idx: FlatFullIndex<retrieval::metric::MetricL2, f32> =
        //     FlatFullIndex::new(&params).with_context(|| "unable to create the index")?;
        // aidx = Arc::new(idx);
        // assert!(
        //     ann_idx
        //         .insert(
        ...
        //             .fetch_vectors("sift_base.fvecs", 128)
        //             .expect("unable to fetch base vectors from disk");
        //         let mut eids: Vec<retrieval::ann::EId> = vec![[0u8; 16]; base_vectors.len() / 128];
        //         for i in 0..base_vectors.len() / 128 {
        //             let mut eid: retrieval::ann::EId = [0u8; 16];
        //             BigEndian::write_uint(
        //                 &mut eid,
